...
if(status==null)
{
  System.out.println("leli meri jannnnnnnnnnn");
%>
...
{	
  ...
  sub_track=mock_test_sub+"_easy";
  count_easy=(String)session.getAttribute("count_easy");
  qajb=oud.oaapQuestionFetch(mock_test_sub,"easy",count_easy);
...
{
  sub_track=mock_test_sub+"_medium";
   count_medium=(String)session.getAttribute("count_medium");
    qajb=oud.oaapQuestionFetch(mock_test_sub,"medium",count_medium);
...
{
  sub_track=mock_test_sub+"_hard";
    count_hard=(String)session.getAttribute("count_hard");
     qajb=oud.oaapQuestionFetch(mock_test_sub,"hard",count_hard);
      ...
      <div class="col" id="exam_panel_headerR" style="">
          <div class="row">
            ...
            <div class="col" id="header_endexam" style="">
                  <button class="btn btn-primary" style="overflow:inherit;">End Exam</button>
               </div>
			   </form>
