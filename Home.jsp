...
System.out.println("logout_status="+logout_status);
...
document.getElementById('login').innerHTML=document.getElementById("login_status_username").value.toUpperCase();
...
System.out.println("login_S"+(String)session.getAttribute("login_status"));
System.out.println("logout_S"+(String)session.getAttribute("logout_status"));
 
System.out.println((String)session.getAttribute("login_status"));
  ...
  session.setAttribute("logout_status","false");
 ...
 <!--<div class="spinner-border text-primary" id="loader"></div>first row_navbar-->

<!------------N--A--V---I---G--A--T--I---O---N_____B---A-----R------------------------------------------->

<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="opacity:40%;background-color:#17181F;border-radius: 2px;  ">
 ...
 <span class="navbar-brand "><i class="fab fa-asymmetrik"></i></span>
  <span class="navbar-text" style="   white-space: nowrap;font-size: 1em;font-family: Dosis;color: white;">Adaptive Assessment Platform </span>
      ...
      <ul class="navbar-nav" style="margin-left: 13vw; display_block ">
         ...
         --<a class="nav-link dropdown-toggle=" data-toggle="dropdown" data-target="#dropdown_target" href="#">Home</a>
...
<!----------------------------LOGIN LOGIC-------------------------------------------->
       <form action="\oaap\login.jsp" method="post" name="signin" onsubmit="return login_validation()">
		...
		<br>
          <input type="text" name="username"  id="username" placeholder="Enter Username" style="">
            ...
            <hr><!--------------New Line-------------->
             ...
             <hr>
                    <button class="btn btn-primary" onclick="signin()" style="margin-left:2vw;width: 18vw" >Login</button><a href="#" id="forgot_password"style="margin-left: 1vw;font-size: .8em;font-family: Dosis;color:blue;">Forgot Password?</a>
...
<div class="container-fluid" style="background: url('oaa4.jpg') no-repeat fixed center;width:100%">
	<div class="row" style="" >

    	  <!--First row_image-->"
  <div class="col-12" id="row1" style="">

<h1 id="website_title" style="white-space:nowrap;" >ONLINE ADAPTIVE ASSESSMENT PLATFORM</h1>
...
<h1 style="margin-top:-6vw;margin-left:-7vw;color:black">Mock Test Modules</h1>
...
<div class="card" id="card_mock_module1">
  <h1 class="card-title" id="card_title" style="">Aptitude</h1>
   ...
   <p class="card-text" id="card_catg" style="">Minimum:  30 Marks</p>
   <p class="card-text" id="card_catg" style="">Maximum:  90 Marks</p>
   <p class="card-text" id="card_catg" style="">Duration: 3 Min / Question</p>
...
<form action="Exam_panel.jsp" method="post">
   ...
   <button type="submit" class="btn btn-success" id="button_begin" onclick="aptitude_begin()">Begin</button>
   <button type="submit" class="btn btn-primary" id="button_accuracy_level">Accuracy Level</button>
...
<!-------------------------------------C----A------R-------D-----5------------------------------------->
  ...
  <div class="card" id="card_mock_module2" style="">
  <h1 class="card-title" id="card_title" style="">Python</h1>
   <img style="" id="card-mock-img" class="card-img-top"  src="https://fi.ge.pgstatic.net/articles/processed/1443012669.1efe9004671444e39aef3c2d694c190b.jpg"  alt="Image" >
...
<form action="Exam_panel.jsp" method="post">
   <div class="card-block" id="card_footer">
   	<input type="hidden" name="mock_test" value="Python">
   <button type="submit" class="btn btn-success" id="button_begin">Begin</button>
   <button type="submit" class="btn btn-primary" id="button_accuracy_level">Accuracy Level</button>
...
<!-------------------------------------C----A------R-------D-----6------------------------------------->
  ...
  <div class="card" id="card_mock_module3" style="">
  <h1 class="card-title" id="card_title" style="">C++</h1>
   <img style="" id="card-mock-img" class="card-img-top"  src="https://fi.ge.pgstatic.net/articles/processed/1443012669.1efe9004671444e39aef3c2d694c190b.jpg"  alt="Image" >
...
<form action="Exam_panel.jsp" method="post">
   <div class="card-block" id="card_footer">
   	<input type="hidden" name="mock_test" value="C++">
   <button type="submit" class="btn btn-success" id="button_begin">Begin</button>
   <button type="submit" class="btn btn-primary" id="button_accuracy_level">Accuracy Level</button>
